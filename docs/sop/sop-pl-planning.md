...
**b.**	The Project System Owner receives a signed acknowledgment from such individuals that are not CivicActions employees, indicating that they have read, understand, and agree to abide by the rules of behavior, before authorizing access to information and the information system.
...
**c.**	Project reviews the Rules of Behavior at least annually and updates it as required.


CivicActions reviews the CivicActions Security Policy at least annually and updates as required.

**d.**	Project requires individuals who have signed a previous version of the rules of behavior to read and re-sign when the Rules of Behavior are revised/updated.
